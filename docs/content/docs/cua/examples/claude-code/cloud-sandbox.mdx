...
See the [Claude Code integration guide](/cua/guide/integrations/claude-code) for more patterns like working on repositories, resuming sessions, and custom system prompts.
