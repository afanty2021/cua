...
The HUD integration allows an agent to be benchmarked using the [HUD framework](https://www.hud.ai/). Through the HUD integration, the agent controls a computer inside HUD, where tests are run to evaluate the success of each task.
...
1. **[OSWorld-Verified](/cua/guide/integrations/benchmarks/osworld-verified)** – Benchmark on 369+ real-world desktop tasks across Chrome, LibreOffice, GIMP, VS Code, etc.
...
See the [HUD docs](https://docs.hud.ai/platform/environments) for more eval environments.
